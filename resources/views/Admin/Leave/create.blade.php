...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">{{ trans('lang.dashboard')}} {{ trans('lang.dashboard')}}Leave Request</div>
  ...
  @endforeach
	...
	<div class="form-group">
							<label class="col-md-4 control-label">{{ trans('lang.dashboard')}} {{ trans('lang.dashboard')}}Start Date*</label>
							<div class="col-md-6">
...
<span class="glyphicon glyphicon-calendar"></span>
	...
	<div class="form-group">
							<label class="col-md-4 control-label">{{ trans('lang.dashboard')}} {{ trans('lang.dashboard')}}End Date*</label>
							<div class="col-md-6">
                            <div class='input-group date'>
...
<div class="form-group">	
							<label class="col-md-4 control-label">{{ trans('lang.dashboard')}}Reason*</label>
							<div class="col-md-6">
